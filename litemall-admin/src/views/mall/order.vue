<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input v-model="listQuery.nickname" clearable class="filter-item" style="width: 160px;"
      ...
      <el-input v-model="listQuery.orderSn" clearable class="filter-item" style="width: 160px;"
      ...
      <el-date-picker v-model="listQuery.timeArray" type="datetimerange" value-format="yyyy-MM-dd HH:mm:ss"
                      class="filter-item" :range-separator="$t('mall_order.text.date_range_separator')"
                      :start-placeholder="$t('mall_order.placeholder.filter_time_start')"
                      :end-placeholder="$t('mall_order.placeholder.filter_time_end')" :picker-options="pickerOptions"/>
    ...
    <el-table v-loading="listLoading" :data="list" :element-loading-text="$t('app.message.list_loading')" border fit
      ...
      <el-table-column align="center" :label="$t('mall_order.table.actions')" width="250" class-name="oper">
        <template slot-scope="scope">
          ...
          <el-button type="warning" size="mini" @click="handlePay(scope.row)">{{ $t('mall_order.button.pay') }}
          </el-button>
          <el-button type="primary" size="mini" @click="handleShip(scope.row)">{{ $t('mall_order.button.ship') }}
          </el-button>
          <el-button type="danger" size="mini" @click="handleRefund(scope.row)">{{ $t('mall_order.button.refund') }}
          </el-button>
        </template>
      </el-table-column>
    </el-table>
        ...
        <el-form :data="orderDetail" label-position="left">
          ...
          <el-form-item :label="$t('mall_order.form.detail_goods')">
            <el-table :data="orderDetail.orderGoods" border fit highlight-current-row>
              ...
              <el-table-column align="center" :label="$t('mall_order.table.detail_goods_specifications')"
                               prop="specifications"/>
