<template>
  <div class="app-container">
      ...
      <el-table-column align="center" :label="$t('profile_notice.table.read_time')" prop="readTime" width="120">
        <template slot-scope="scope">
          <el-tag :type="scope.row.readTime ? 'success' : 'error' ">{{ $t(scope.row.readTime ?
            'profile_notice.text.read' : 'profile_notice.text.unread') }}
          </el-tag>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="notice.title" :visible.sync="noticeVisible" center>
      <el-divider content-position="left">{{ $t('profile_notice.text.admin_time', { admin: notice.admin, time:
        notice.time }) }}
      </el-divider>
