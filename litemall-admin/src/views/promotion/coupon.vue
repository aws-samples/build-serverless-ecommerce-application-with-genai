    ...
    <el-table v-loading="listLoading" :data="list" :element-loading-text="$t('app.message.list_loading')" border fit
      ...
      <el-table-column align="center" :label="$t('promotion_coupon.table.discount')" prop="discount">
        <template slot-scope="scope">{{
            $t('promotion_coupon.text.coupon_discount', {discount: scope.row.discount})
          }}
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" :label="$t('promotion_coupon.table.limit')" prop="limit">
        <template slot-scope="scope">{{
            scope.row.limit != 0 ? scope.row.limit : $t('promotion_coupon.text.unlimited')
          }}
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" :label="$t('promotion_coupon.table.total')" prop="total">
        <template slot-scope="scope">{{
            scope.row.total != 0 ? scope.row.total : $t('promotion_coupon.text.unlimited')
          }}
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" :label="$t('promotion_coupon.table.actions')" width="300"
                       class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button v-permission="['GET /admin/coupon/read']" type="primary" size="mini"
                     @click="handleDetail(scope.row)">{{ $t('app.button.detail') }}
          </el-button>
        ...
        <el-form-item v-show="dataForm.goodsType === 1">
          ...
          >
            <el-table-column :label="$t('promotion_coupon.table.category_name')" align="center">
              <template slot-scope="scope">{{ scope.row.parentCategoryName }}>{{
