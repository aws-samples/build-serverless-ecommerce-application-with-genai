<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.sort" class="filter-item"
    ...
    <div class="operator-container">
      ...
      <el-button v-permission="['POST /admin/topic/batch-delete']" class="filter-item" type="danger"
                 icon="el-icon-delete" @click="handleBatchDelete">{{ $t('app.button.batch_delete') }}
      </el-button>
    </div>
    ...
    <el-table v-loading="listLoading" :data="list" :element-loading-text="$t('app.message.list_loading')" border fit
      ...
      <el-table-column align="center" :label="$t('promotion_topic.table.actions')" min-width="100"
