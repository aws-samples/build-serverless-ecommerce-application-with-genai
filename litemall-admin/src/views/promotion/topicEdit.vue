  ...
  <div class="app-container">
    ...
    <el-form ref="topic" :rules="rules" :model="topic" status-icon label-position="left" label-width="100px"
      ...
      <el-form-item :label="$t('promotion_topic_edit.form.goods')" prop="goods">
        <el-button style="float:right;" size="mini" type="primary" @click="handleCreate()">{{
          $t('promotion_topic_edit.button.goods_create') }}
        </el-button>
        ...
        <el-table :data="goodsList" border fit highlight-current-row>
          ...
          <el-table-column align="center" :label="$t('promotion_topic_edit.table.goods_actions')"
    ...
    <el-dialog :visible.sync="addVisiable" :title="$t('promotion_topic_edit.dialog.add_goods')">
      <div class="search">
        ...
        <el-table v-loading="listLoading" :data="list" :element-loading-text="$t('app.message.list_loading')" border fit
          ...
          <el-table-column align="center" property="picUrl"
