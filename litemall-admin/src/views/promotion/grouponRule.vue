<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" :element-loading-text="$t('app.message.list_loading')" border fit
      ...
      <el-table-column align="center" min-width="100" :label="$t('promotion_groupon_rule.table.goods_name')"
                       prop="goodsName"/>
      ...
      <el-table-column align="center" :label="$t('promotion_groupon_rule.table.discount_member')"
                       prop="discountMember"/>
      ...
      <el-table-column align="center" :label="$t('promotion_groupon_rule.table.actions')" width="200"
