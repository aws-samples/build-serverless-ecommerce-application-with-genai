  ...
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-form ref="goods" :rules="rules" :model="goods" label-width="150px">
        ...
        <el-form-item :label="$t('goods_edit.form.keywords')">
          ...
          <el-button v-else class="button-new-keyword" type="primary" @click="showInput">{{ $t('app.button.add') }}
          </el-button>
        </el-form-item>
    ...
    <el-card class="box-card">
      ...
      <el-table :data="specifications">
        ...
        <el-table-column align="center" :label="$t('goods_edit.table.specification_actions')" width="200"
                         class-name="small-padding fixed-width">
          <template slot-scope="scope">
            <el-button type="primary" size="mini" @click="handleSpecificationShow(scope.row)">{{
    ...
    <el-card class="box-card">
      ...
      <el-table :data="products">
        ...
        <el-table-column align="center" :label="$t('goods_edit.table.product_actions')" width="200"
                         class-name="small-padding fixed-width">
          <template slot-scope="scope">
            <el-button type="primary" size="mini" @click="handleProductShow(scope.row)">{{ $t('app.button.settings')
              }}
            </el-button>
          </template>
        </el-table-column>
    ...
    <el-card class="box-card">
      ...
      <el-table :data="attributesData">
        ...
        <el-table-column align="center" :label="$t('goods_edit.table.attribute_actions')" width="200"
                         class-name="small-padding fixed-width">
          <template slot-scope="scope">
            <el-button type="primary" size="mini" @click="handleAttributeShow(scope.row)">{{ $t('app.button.settings')
              }}
            </el-button>
            <el-button type="danger" size="mini" @click="handleAttributeDelete(scope.row)">{{ $t('app.button.delete')
              }}
            </el-button>
          </template>
        </el-table-column>
      ...
      <el-dialog :visible.sync="attributeVisiable"
                 :title="$t(attributeAdd ? 'goods_edit.dialog.edit_attribute_add' : 'goods_edit.dialog.edit_attribute_edit')">
        ...
        <div slot="footer" class="dialog-footer">
          ...
          <el-button v-if="attributeAdd" type="primary" @click="handleAttributeAdd">{{ $t('app.button.confirm') }}
          </el-button>
